<?php
class brezza_ControllerProductProduct extends ControllerProductProduct {
...
public function preRender( $template_buffer, $template_name, &$data ) {
      ...
      return parent::preRender( $template_buffer, $template_name, $data );
        ...
        $data['magikbrezza_productpage_related_cb']=$this->config->get('magikbrezza_productpage_related_cb');
        $data['magikbrezza_productpage_related_cbcontent']=$this->config->get('magikbrezza_productpage_related_cbcontent');
...
public function info()
    {
        ...
        $this->response->setOutput($this->load->view('product/magikrelated_list', $data));
