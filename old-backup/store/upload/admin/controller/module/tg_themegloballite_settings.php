	...
	public function index() {   
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			if(isset($_POST['button-active'])){
	            ...
	            $this->response->redirect($this->url->link('module/tg_themegloballite_settings&submit=true', 'token=' . $this->session->data['token'], true));
            }
		}
			...
			if(isset($_POST['button-save'])){
				if(is_writable(DIR_CATALOG . 'view/theme/themegloballite/skins') && is_writable(DIR_CATALOG . 'view/theme/themegloballite/skins/store_'.$data['edit_skin_store']) && is_writable(DIR_CATALOG . 'view/theme/themegloballite/skins/store_'.$data['edit_skin_store'].'/'.$data['active_skin_edit'])) {
					...
					if(file_exists(DIR_CATALOG . 'view/theme/themegloballite/skins/store_'.$data['edit_skin_store'].'/') && filetype(DIR_CATALOG . 'view/theme/themegloballite/skins/store_'.$data['edit_skin_store'].'/') == 'dir' && file_exists(DIR_CATALOG . 'view/theme/themegloballite/skins/store_'.$data['edit_skin_store'].'/'.$data['active_skin_edit'].'')) {
						...
						$this->session->data['success'] = $this->language->get('text_success');
						$this->response->redirect($this->url->link('module/tg_themegloballite_settings&submit=true&skin_edit=' . $data['active_skin_edit'] . '', 'token=' . $this->session->data['token'], true));
					}
				}
		...
		foreach ($text_strings as $text) {
			...
			if(isset($_POST['install_tg_tglite_revolution_slider'])){
				...
				$this->session->data['success'] = $this->language->get('text_success');
				$this->response->redirect($this->url->link('module/tg_themegloballite_settings', 'token=' . $this->session->data['token'], true));
		...
		$data['action'] = $this->url->link('module/tg_themegloballite_settings', 'token=' . $this->session->data['token'], true);
		...
		//Send the output.
		$this->response->setOutput($this->load->view('module/tg_themegloballite_settings', $data));
	}
