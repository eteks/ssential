...
class ControllerModuleTGthemegloballiteMegamenu extends Controller {
	...
	public function index() {  
		...
		$this->language->load('module/tg_themegloballite_megamenu');
		...
		if(isset($_GET['delete'])) {
			...
			$this->response->redirect($this->url->link('module/tg_themegloballite_megamenu', 'token=' . $this->session->data['token'], true));
		}
		...
		$data['action'] = $this->url->link('module/tg_themegloballite_megamenu', 'token=' . $this->session->data['token'], true);
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('module/tg_themegloballite_megamenu', 'token=' . $this->session->data['token'], true)
		);
		...
		$this->response->setOutput($this->load->view('module/tg_themegloballite_megamenu', $data));
	
	}
	
	private function validate() {
		if (!$this->user->hasPermission('modify', 'module/tg_themegloballite_megamenu')) {
