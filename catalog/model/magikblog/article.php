...
class ModelMagikblogArticle extends Model {
	...
	public function getcategoryNamebyArticle($mgkblogarticle_id){ 
	   $sql="SELECT mbd.name as categoryname,mbc.category_id as categoryid FROM " . DB_PREFIX . "magikblog_to_category mbc  
					 LEFT JOIN " . DB_PREFIX . "magikblogcategory_description mbd ON (mbc.category_id = mbd.category_id) 
					   WHERE mbc.blog_id = '" . (int)$mgkblogarticle_id . "' GROUP BY mbc.category_id";
	     ...
	     $result='';
		  ...
		  foreach ($query->rows as $row) {
			  ...
			  $link=$this->url->link('magikblog/category', 'mgkblogcategory_id=' . $categoryid);
