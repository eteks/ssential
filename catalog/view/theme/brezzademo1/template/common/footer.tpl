      ...
      <div class="row">
         ...
         <div class="col-sm-12 col-xs-12 col-lg-8">
          ...
          <div class="col-xs-12 col-lg-4">
            ...
            <img alt="payment1" src="catalog/view/theme/<?php echo $magik_theme ?>/image/payment-1.png"> 

            <img alt="payment2" src="catalog/view/theme/<?php echo $magik_theme ?>/image/payment-2.png"> 

            <img alt="payment3" src="catalog/view/theme/<?php echo $magik_theme ?>/image/payment-3.png"> 

            <img alt="payment4" src="catalog/view/theme/<?php echo $magik_theme ?>/image/payment-4.png">
...
<div class="footer-middle">
    ...
    <div class="container">
      ...
      <div class="row">
            ...
            <?php if($magikbrezza_footer_cb==1){  ?> 

             <?php echo $magikbrezza_footer_cbcontent; ?> 

             <?php } ?>              

                  <address>

                      <?php if ($magikbrezza_address):?>

                      <i class="fa fa-map-marker"></i><?php echo html_entity_decode($magikbrezza_address); ?>                 

                      <?php endif;?>

                      

                      <?php if ($magikbrezza_phone) : ?>

                   

                     <i class="fa fa-mobile"></i>

                    <span> <?php echo $magikbrezza_phone; ?></span>
                      ...
                      <?php if ($magikbrezza_email): ?>

                        <i class="fa fa-envelope"></i><span>

                      <?php echo $magikbrezza_email; ?></span>
 ...
 if($magikbrezza_footer_fb==1) {

 echo $magikbrezza_footer_fbcontent;
...
<div class="footer-bottom">
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        if(trim($magikbrezza_powerby) != '') {

          echo html_entity_decode($magikbrezza_powerby);
...
<?php if($magikbrezza_scroll_totop!=1) { ?>
