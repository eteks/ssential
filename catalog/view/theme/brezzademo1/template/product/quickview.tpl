...
<link href="catalog/view/theme/<?php echo $magik_theme ?>/stylesheet/flexslider.css" rel="stylesheet">
<script type="text/javascript" src="catalog/view/theme/<?php echo $magik_theme ?>/js/jquery.flexslider.js"></script> 
<script type="text/javascript" src="catalog/view/theme/<?php echo $magik_theme ?>/js/cloudzoom.js"></script>
          ...
          <div class="product-essential">
           ...
           <div class="product-shop col-lg-7 col-sm-7 col-xs-12">
             ...
             <ul class="list-unstyled">
			  ...
			  <?php if ($weight) { ?>
              <li><span><?php echo $text_weight; ?></span> <a href="<?php echo $weight; ?>"><?php echo round($weight, 4) . ' ' . $weightunit; ?></a></li>
              <?php } ?>
              <?php if ($reward) { ?>
...
<!--               <div class="form-group">
          ...
          <li><a class="link-wishlist" title="<?php echo $button_wishlist; ?>" onclick="mgk_qv_wishlist.add('<?php echo $product_id; ?>');">
          <span><?php echo $button_wishlist; ?></span>
          </a></li>
          <li><a class="link-compare"  title="<?php echo $button_compare; ?>" onclick="mgk_qv_compare.add('<?php echo $product_id; ?>');">
