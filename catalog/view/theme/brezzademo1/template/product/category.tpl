      ...
      <article class="col-main">
        <?php if ($products) { ?>
          <div class="catalog-product-info"> 
           <h2 class="page-heading clearfix"> <span class="page-heading-title"><?php echo $heading_title; ?></span> </h2>
		   <div class="clearfix"></div>
		   <?php if ($thumb || $description) { ?>
      <div class="row mrg-top-15">	  
        <?php if (!$thumb) { ?>
			<div class="col-sm-12 text-justify"><?php echo $description; ?></div>
		<?php } elseif (!$description) { ?>
        <div class="col-sm-2"><img src="<?php echo $thumb; ?>" alt="<?php echo $heading_title; ?>" title="<?php echo $heading_title; ?>" class="img-thumbnail" /></div>
        <?php } else { ?>
        <div class="col-sm-2"><img src="<?php echo $thumb; ?>" alt="<?php echo $heading_title; ?>" title="<?php echo $heading_title; ?>" class="img-thumbnail" /></div>
        <div class="col-sm-10 pull-right text-justify"><?php echo $description; ?></div>
        <?php } ?>
      </div>
      <hr>
      <?php } ?>
              ...
              <div class="item-inner">
                    <div class="item-img">
                        <div class="item-img-info">
                          ...
                          <div class="box-hover">
                            ...
                            <?php if($magikbrezza_quickview_button== 1) { ?>
                            <li>
                    ...
                    <div class="item-info">
                        <div class="info-inner">
                            ...
                            <?php echo $pro_name = (strlen($product['name'])>50) ? substr($product['name'], 0,50).'...' : $product['name']; ?>
                            </a>
                            </div>
