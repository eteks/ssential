                   ...
                   <div class="item-inner">
                     <div class="item-img">
                      ...
                      <ul class="add-to-links">
                        ...
                        <li>
                          <a onclick="mgk_hm_wishlist.add('<?php echo $product['product_id']; ?>');" class="link-wishlist"><?php echo $button_wishlist; ?></a> 
                        </li>
                        <li>
                          ...
                          <div class="blog-preview_info">    
                           <ul class="post-meta">                           
                             <li><i class="fa fa-user"></i>posted by <a href="<?php echo $relatedarticle['href']; ?>"><?php echo $relatedarticle['author']; ?></a></li>
                              ...
                              <li><i class="fa fa-calendar"></i><?php $mgkpublish_date = strtotime( $relatedarticle['publish_date'] );
                            echo $mysqldate = date( 'M d, Y', $mgkpublish_date );?></li>
                            </ul>                                                   
