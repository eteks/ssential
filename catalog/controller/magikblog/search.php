<?php
class ControllerMagikblogSearch extends Controller {
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('magikblog/search', 'mgktag=' . $this->request->get['mgktag'])
		);
		...
		$pagination->url = $this->url->link('magikblog/search','mgktag=' . $this->request->get['mgktag']. '&page={page}');
		...
		$this->response->setOutput($this->load->view('magikblog/article_tag', $data));
