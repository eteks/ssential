...
class ControllerExtensionModuleMagiklatestbycategory  extends Controller {
	...
	public function index($setting) {
		...
		$results1 = $this->model_extension_module_magiklatest_by_category->getmagiklatestCategoryProducts($data1);
		...
		$results2 = $this->model_extension_module_magiklatest_by_category->getmagiklatestCategoryProducts($data2);
		...
		$results3 = $this->model_extension_module_magiklatest_by_category->getmagiklatestCategoryProducts($data3);
		...
		$results4 = $this->model_extension_module_magiklatest_by_category->getmagiklatestCategoryProducts($data4);
		...
		// $results5 = $this->model_extension_module_magiklatest_by_category->getmagiklatestCategoryProducts($data5);
		...
		return $this->load->view('extension/module/magiklatest_by_category', $data);
