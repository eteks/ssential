        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-store" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" name="config_google_site_verification" value="<?php echo $config_google_site_verification; ?>" placeholder="<?php echo $entry_google_site_verification; ?>" id="input-google_site_verification" class="form-control" />
              </div>
            </div>
