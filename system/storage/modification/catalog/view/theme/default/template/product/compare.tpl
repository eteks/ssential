          ...
          <td>
                    <?php
                        if ($product['quantity']>0){ 
                            ?><input type="button" value="<?php echo $button_cart; ?>" class="btn btn-primary btn-block" onclick="cart.add('<?php echo $product['product_id']; ?>', '<?php echo $product['minimum']; ?>');" /><?php
                            }else{
                        ?><input type="button" value="Enquiry Now" class="btn btn-primary btn-block" onclick="outOfStockEnquiry('<?php echo $product['product_id']; ?>');" />
                        <?php
                        }
                    ?>
