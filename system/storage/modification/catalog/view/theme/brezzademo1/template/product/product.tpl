    ...
    <div class="product-view">
      <div class="product-essential">     
          ...
          <div class="product-img-box col-lg-4 col-sm-5 col-xs-12">
              <?php if($magikbrezza_sale_label==1) { 
                        if ($price && $special) { ?>
                       <div class="new-label new-top-left"><?php echo $magikbrezza_sale_labeltitle; ?></div>
              <?php } }  ?>
          ...
          <div class="product-shop col-lg-8 col-sm-7 col-xs-12">
            ...
            <div class="form-group<?php echo ($option['required'] ? ' required' : ''); ?>">
              ...
              <select name="option[<?php echo $option['product_option_id']; ?>]" id="input-option<?php echo $option['product_option_id']; ?>" class="form-control">
                <!--<option value="">Please select desired qty</option>-->
            ...
            <div class="form-group<?php echo ($option['required'] ? ' required' : ''); ?>">
              ...
              <div id="input-option<?php echo $option['product_option_id']; ?>">
                ...
                <div class="radio">
                  <label>
                    <input class="ch-pri" data-value="<?=$option_value['price'];?>" type="radio" name="option[<?php echo $option['product_option_id']; ?>]" value="<?php echo $option_value['product_option_value_id']; ?>" />
            ...
            <div class="form-group">
              ...
              <br />
                    ...
                    <?php
                        if ($prod_quant>0){
                            ?><button type="button" id="button-cart" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary btn-lg btn-block"><?php echo $button_cart; ?></button><?php
                            }else{
                        ?><button type="button" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary btn-lg btn-block" onclick="outOfStockEnquiry('<?php echo $product_id; ?>');">Enquiry Now</button>
                        <?php
                        }
                    ?>
            ...
            <div class="add-to-box">
              ...
              <li><a class="link-compare"  title="<?php echo $button_compare; ?>" onclick="mgk_compare.add('<?php echo $product_id; ?>');">
          ...
          <div id="related-products-slider" class="product-flexslider hidden-buttons">
            <div class="home-block-inner">
              <div class="block-title">
                   <h2><?php echo $text_related; ?><br><em><?php echo $text_product; ?></em></h2>
                </div>
                  <div class="pretext"><?php if($magikbrezza_productpage_related_cb) { ?>
                      <?php echo html_entity_decode($magikbrezza_productpage_related_cbcontent);?>
                    <?php }  ?> </div>
                     ...
                     <div class="item-img">
                      <div class="item-img-info">
                       ...
                       <?php } ?>
                        ...
                        <div class="sale-label sale-top-right"><?php echo $magikbrezza_sale_labeltitle; ?></div>
                        <?php } }?>
...
/*$('select[id="<?php echo $option['product_option_id']; ?>"]').on('change', function(){
