              ...
              <td class="text-right">
                    <?php
                        if ($product['quantity']>0){ 
                            ?><button type="button" onclick="cart.add('<?php echo $product['product_id']; ?>');" data-toggle="tooltip" title="<?php echo $button_cart; ?>" class="btn btn-primary"><i class="fa fa-shopping-cart"></i></button><?php
                            }else{
                        ?><button type="button" data-toggle="tooltip" title="Enquiry Now" type="button" onclick="outOfStockEnquiry('<?php echo $product['product_id']; ?>');" class="btn btn-primary"><i class="fa fa-question-circle"></i></button>
                        <?php
                        }
                    ?>
