...
class ControllerExtensionModuleRestApi extends Controller
{
	...
	public function add()
	{
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('extension/module/rest_api', 'token=' . $this->session->data['token'] . $url, true));
		}
	...
	protected function getList()
	{
		...
		$data['breadcrumbs'][] = [
			...
			'href' => $this->url->link('extension/module/rest_api', 'token=' . $this->session->data['token'] . $url, true)
		];

		$data['add']    = $this->url->link('extension/module/rest_api/add', 'token=' . $this->session->data['token'] . $url, true);
		$data['delete'] = $this->url->link('extension/module/rest_api/delete', 'token=' . $this->session->data['token'] . $url, true);
		...
		foreach ($apis as $api) {
			$data['apis'][] = [
				...
				'edit'       => $this->url->link('extension/module/rest_api/edit', 'token=' . $this->session->data['token'] . '&id=' . $api['id'] . $url, true)
			];
		}
		...
		$data['sort_username']   = $this->url->link('extension/module/rest_api', 'token=' . $this->session->data['token'] . '&sort=username' . $url, true);
		$data['sort_status']     = $this->url->link('extension/module/rest_api', 'token=' . $this->session->data['token'] . '&sort=status' . $url, true);
		$data['sort_date_added'] = $this->url->link('extension/module/rest_api', 'token=' . $this->session->data['token'] . '&sort=created_at' . $url, true);
		...
		$pagination->url   = $this->url->link('extension/module/rest_api', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
	...
	protected function getForm()
	{
		...
		if (!isset($this->request->get['id'])) {
			$data['action'] = $this->url->link('extension/module/rest_api/add', 'token=' . $this->session->data['token'] . $url, true);
		} else {
			$data['action'] = $this->url->link('extension/module/rest_api/edit', 'token=' . $this->session->data['token'] . '&id=' . $this->request->get['id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('extension/module/rest_api', 'token=' . $this->session->data['token'] . $url, true);
