<?php
class ControllerExtensionModuleMagikblog extends Controller {

    private $error = array(); // This is used to set the errors, if any.
 
    public function index() {
        // Loading the language file of blog
        $this->load->language('extension/module/magikblog'); 
	...
	// Making of Breadcrumbs to be displayed on site
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('extension/module/magikblog', 'token=' . $this->session->data['token'], true),
            'separator' => ' :: '
        );             
         
        $data['action'] = $this->url->link('extension/module/magikblog', 'token=' . $this->session->data['token'], true);
    ...
    if (isset($this->request->post['magikblog_allow_categoryname'])) {
            $data['magikblog_allow_categoryname'] = $this->request->post['magikblog_allow_categoryname'];
    } else {
            $data['magikblog_allow_categoryname'] = $this->config->get('magikblog_allow_categoryname');
    }

    if (isset($this->request->post['magikblog_allow_sociallinks'])) {
            $data['magikblog_allow_sociallinks'] = $this->request->post['magikblog_allow_sociallinks'];
    } else {
            $data['magikblog_allow_sociallinks'] = $this->config->get('magikblog_allow_sociallinks');
    }


    if (isset($this->request->post['magikblog_allow_seolinks'])) {
            $data['magikblog_allow_seolinks'] = $this->request->post['magikblog_allow_seolinks'];
    } else {
            $data['magikblog_allow_seolinks'] = $this->config->get('magikblog_allow_seolinks');
    }
    
	$data['header'] = $this->load->controller('common/header');
        $data['column_left'] = $this->load->controller('common/column_left');
        $data['footer'] = $this->load->controller('common/footer');
        $this->response->setOutput($this->load->view('extension/module/magikblog', $data));
    ...
    protected function validate() {
        ...
        if (!$this->user->hasPermission('modify', 'extension/module/magikblog')) {
