<?php
class ControllerExtensionModuleMagikblogHomepage extends Controller {
    private $error = array(); // This is used to set the errors, if any.
 
    public function index() {
        // Loading the language file of blog homepage
        $this->load->language('extension/module/magikblog_homepage'); 
	...
	// Making of Breadcrumbs to be displayed on site
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('extension/module/magikblog_homepage', 'token=' . $this->session->data['token'], true),
            'separator' => ' :: '
        );        

        $data['action'] = $this->url->link('extension/module/magikblog_homepage', 'token=' . $this->session->data['token'], true);
	...
	if (isset($this->request->post['magikblog_homepage_resizeimageheight'])) {
        ...
        $this->response->setOutput($this->load->view('extension/module/magikblog_homepage', $data));
    ...
    protected function validate() {
        ...
        if (!$this->user->hasPermission('modify', 'extension/module/magikblog_homepage')) {
