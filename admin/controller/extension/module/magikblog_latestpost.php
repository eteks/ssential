<?php
class ControllerExtensionModuleMagikblogLatestpost extends Controller {
    private $error = array(); // This is used to set the errors, if any.
 
    public function index() {
        // Loading the language file of blog latest posts
        $this->load->language('extension/module/magikblog_latestpost'); 
	...
	// Making of Breadcrumbs to be displayed on site
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('extension/module/magikblog_latestpost', 'token=' . $this->session->data['token'], true),
            'separator' => ' :: '
        );       
        
        $data['action'] = $this->url->link('extension/module/magikblog_latestpost', 'token=' . $this->session->data['token'], true);
	...
	$data['header'] = $this->load->controller('common/header');
        ...
        $this->response->setOutput($this->load->view('extension/module/magikblog_latestpost', $data));
    ...
    protected function validate() {
        ...
        if (!$this->user->hasPermission('modify', 'extension/module/magikblog_latestpost')) {
