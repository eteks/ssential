...
class ControllerMagikblogComment extends Controller {
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) { 
			...
			$this->response->redirect($this->url->link('magikblog/comment', 'token=' . $this->session->data['token'] . $url, true));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('magikblog/comment', 'token=' . $this->session->data['token'] . $url, true)
		);
		$data['add'] = $this->url->link('magikblog/comment/add', 'token=' . $this->session->data['token'] . $url, true);
		$data['delete'] = $this->url->link('magikblog/comment/delete', 'token=' . $this->session->data['token'] . $url, true);
		...
		foreach ($results as $result) {
			$data['articlecomments'][] = array(
				...
				'edit'       => $this->url->link('magikblog/comment/edit', 'token=' . $this->session->data['token'] . '&comment_id=' . $result['comment_id'] . $url, true)
		...
		$data['sort_articlename'] = $this->url->link('magikblog/comment', 'token=' . $this->session->data['token'] . '&sort=md.name' . $url, true);
		$data['sort_user'] = $this->url->link('magikblog/comment', 'token=' . $this->session->data['token'] . '&sort=mbc.user' . $url, true);
		$data['sort_status'] = $this->url->link('magikblog/comment', 'token=' . $this->session->data['token'] . '&sort=mbc.status' . $url, true);
		$data['sort_createdat'] = $this->url->link('magikblog/comment', 'token=' . $this->session->data['token'] . '&sort=mbc.created_at' . $url, true);
		...
		$pagination->url = $this->url->link('magikblog/comment', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
		...
		$this->response->setOutput($this->load->view('magikblog/comment', $data));
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['comment_id'])) {
			$data['action'] = $this->url->link('magikblog/comment/add', 'token=' . $this->session->data['token'] . $url, true);
		} else {
			$data['action'] = $this->url->link('magikblog/comment/edit', 'token=' . $this->session->data['token'] . '&comment_id=' . $this->request->get['comment_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('magikblog/comment', 'token=' . $this->session->data['token'] . $url, true);
		...
		$this->response->setOutput($this->load->view('magikblog/comment_form', $data));
	}
	...
	public function add() { 
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) { 
			...
			$this->response->redirect($this->url->link('magikblog/comment', 'token=' . $this->session->data['token'], true));
		}
