...
class ModelMagikblogCategory extends Model {
	...
	public function getBlogcategorykeyword($category_id) {
		  ...
		  $query = $this->db->query("SELECT DISTINCT keyword FROM " . DB_PREFIX . "url_alias m WHERE query = 'mgkblogcategory_id=" . (int)$category_id . "' ");
	      return $query->row;
	}
	...
	public function addBlogcategory($data) {
		...
		if ($data['keyword']) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "url_alias SET query = 'mgkblogcategory_id=" . (int)$category_id . "', keyword = '" . $this->db->escape($data['keyword']) . "'");
		}
	...
	public function editBlogcategory($category_id, $data){
		...
		//keyword
		$this->db->query("DELETE FROM " . DB_PREFIX . "url_alias WHERE query = 'mgkblogcategory_id=" . (int)$category_id . "'");
