                      ...
                      <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="text-right">
                                 <button class="btn btn-warning" onclick="edit_ware(<?php echo $store['warehouse_id']; ?>)"><i class="glyphicon glyphicon-pencil"></i></button>
                                 <button class="btn btn-danger" onclick="delete_ware(<?php echo $store['warehouse_id']; ?>)"><i class="glyphicon glyphicon-remove"></i></button>
                            </td>
                          </tr>
                          <?php 
                              }
  ...
  function edit_ware(id)
   {
        ...
        $.ajax({
          ...
          success: function(data)
          {
              ...
              $('[name="city"]').val(data.warehouse_city);
              $('[name="country"]').val(data.warehouse_country);
              $('[name="pin"]').val(data.warehouse_pincode);
              $('[name="contact_person"]').val(data.contact_person);
              $('[name="email"]').val(data.warehouse_email);
