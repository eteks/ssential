...
<br><br>
		  ...
		  <div class="form-group">
			<label class="col-sm-2 control-label" for="input-mgkblogcategorynametatus_ed"><?php echo $entry_allowcategoryname; ?></label>
			<div class="col-sm-10">
			    <label class="radio-inline">
			      <?php if ($magikblog_allow_categoryname) { ?>
			      <input type="radio" name="magikblog_allow_categoryname" value="1" checked="checked" />
			      <?php echo $text_yes; ?>
			      <?php } else { ?>
			      <input type="radio" name="magikblog_allow_categoryname" value="1" />
			      <?php echo $text_yes; ?>
			      <?php } ?>
			    </label>
			    <label class="radio-inline">
			      <?php if (!$magikblog_allow_categoryname) { ?>
			      <input type="radio" name="magikblog_allow_categoryname" value="0" checked="checked" />
			      <?php echo $text_no; ?>
			      <?php } else { ?>
			      <input type="radio" name="magikblog_allow_categoryname" value="0" />
			      <?php echo $text_no; ?>
			      <?php } ?>
			    </label>
			</div>
		  	...
		  	<div class="form-group">
			<label class="col-sm-2 control-label" for="input-mgkblogallowsociallinks_ed"><?php echo $entry_allowsociallinks; ?></label>
			<div class="col-sm-10">
			    <label class="radio-inline">
			      <?php if ($magikblog_allow_sociallinks) { ?>
			      <input type="radio" name="magikblog_allow_sociallinks" value="1" checked="checked" />
			      <?php echo $text_yes; ?>
			      <?php } else { ?>
			      <input type="radio" name="magikblog_allow_sociallinks" value="1" />
			      <?php echo $text_yes; ?>
			      <?php } ?>
			    </label>
			    <label class="radio-inline">
			      <?php if (!$magikblog_allow_sociallinks) { ?>
			      <input type="radio" name="magikblog_allow_sociallinks" value="0" checked="checked" />
			      <?php echo $text_no; ?>
			      <?php } else { ?>
			      <input type="radio" name="magikblog_allow_sociallinks" value="0" />
			      <?php echo $text_no; ?>
			      <?php } ?>
			    </label>
			</div>
		  	...
		  	<div class="form-group">
			<label class="col-sm-2 control-label" for="input-mgkblogallowseolinks_ed"><span data-toggle="tooltip" title="<?php echo $help_allowseolinks; ?>"><?php echo $entry_allowseolinks; ?></span></label>
			<div class="col-sm-10">
			    <label class="radio-inline">
			      <?php if ($magikblog_allow_seolinks) { ?>
			      <input type="radio" name="magikblog_allow_seolinks" value="1" checked="checked" />
			      <?php echo $text_yes; ?>
			      <?php } else { ?>
			      <input type="radio" name="magikblog_allow_seolinks" value="1" />
			      <?php echo $text_yes; ?>
			      <?php } ?>
			    </label>
			    <label class="radio-inline">
			      <?php if (!$magikblog_allow_seolinks) { ?>
			      <input type="radio" name="magikblog_allow_seolinks" value="0" checked="checked" />
			      <?php echo $text_no; ?>
			      <?php } else { ?>
			      <input type="radio" name="magikblog_allow_seolinks" value="0" />
			      <?php echo $text_no; ?>
			      <?php } ?>
			    </label>
			</div>
